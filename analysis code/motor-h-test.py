    ...
    for dir_name in dirs:
        ...
        if dir_name[0] == 'a':
            if dir_name[-1] == '1':
                ...
                a_01['walking speed'].append(walking_speed.loc[:,'walking speed'].std())
                ...
                a_02['walking speed'].append(walking_speed.loc[:,'walking speed'].std())
            ...
            if dir_name[-1] == '1':
                ...
                b_01['walking speed'].append(walking_speed.loc[:,'walking speed'].std())
                ...
                b_02['walking speed'].append(walking_speed.loc[:,'walking speed'].std())
...
for i in range(len(keys)):
    print(keys[i])
    stat, p_value = kruskal(a_01[keys[i]] + b_01[keys[i]], a_02[keys[i]], b_02[keys[2]])
